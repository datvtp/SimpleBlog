 ...
 * @author vanth
 */
public class MemberViewDetailArticleController extends HttpServlet {

    private static final Logger logger = Logger.getLogger(MemberViewDetailArticleController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("ERROR NumberFormat at MemberViewDetailArticleController: " + e.getMessage());
        } catch (SQLException e) {
            logger.error("ERROR SQL at MemberViewDetailArticleController: " + e.getMessage());
        } catch (NamingException e) {
            logger.error("ERROR Naming at MemberViewDetailArticleController: " + e.getMessage());
        } finally {
            request.getRequestDispatcher("memberViewDetailArticle.jsp").forward(request, response);
        }
    }
